...
export default function BugTrackerInstall() {
  return (
    <React.Fragment>
      <Head>
        <title>Bug Tracker Install</title>
        <meta
          name="description"
          content="Step-by-step guide for installing Bug Tracker from BangDB Appstore."
        ></meta>
        <meta property="og:site_name" content="BangDB Docs" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Bug Tracker Install" />
        <meta
        ...
        <meta name="twitter:title" content="Bug Tracker Install" />
        <meta
        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Bug Tracker Install</h1>
              <div className="article-body">
                ...
                <h2>Step 2: Search for Bug Tracker</h2>
                <p>
                  Once on the BangDB Appstore page, use the search functionality
                  to find the <strong>Bug Tracker</strong> application.
                </p>
                <img
                ...
                <p>
                  After finding Bug Tracker, click on its app card or the{" "}
