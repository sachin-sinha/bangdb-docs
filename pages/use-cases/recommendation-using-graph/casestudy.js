      ...
      <DocArticle>
        ...
        <div className="article-body">
          ...
          <p>
            ...
            with logical hierarchy also preserved as far as possible. And above
            this, it is also very important that the graph scales well and
            performance for both read and write is high. Further, we must also
            ensure that data preserves the natural groups, cliques, segments
            etc. Finally, we must also ensure that the Graph uses nomenclatures
            which is natural to the domain and aligns with RDF models.
          </p>
          <p>
            To ensure that, these flexibilities are there in the structure, the
            document also lists several queries that might be performed in
            production and to enable the use cases. The queries are benchmarked
            for REST call (which is most conservative and would kind of provide
            the baseline). The results of the queries are also depicted
            pictorially for clarity. Further, these queries can be extended or
            more can be added as needed. As of now it lists over 40 such query
            templates with over 100 possible variations for different
            permutations and combinations for different contexts. This is to
            ensure that there is enough flexibility in the structure to query in
            many ways.
          </p>
          <p>
            Note: The Graph, and related details (including queries) are subject
            to the receipt and test on actual data. These may change once we get
            the data, but the current structure should take care of the change
            easily
          </p>
        ...
        <div className="table-container">
          ...
          <div className="table-container">
            ...
            <p>
              ...
              more than one address (such as HOME, OFFICE) and for every address
              we will have latitude and longitude associated with it.
            </p>
            <br></br>
            <ul>
            ...
            <ul>
              ...
              <li>i. Find all customers whose office addresses are missing</li>
              <li>
          ...
          <ul>
            ...
            <li>
              ...
              villages or a few wards (taluk’s definition differs from state to
              state). So, using it as a property is better than as a node.
            </li>
          </ul>
          <img
          ...
          <p>
            ...
            therefore we will use “Lat, Lon” to figure out the pincode. If “Lat,
            Lon” is also null, then we can use “taluk” info for the same. If
            “taluk” is also null, then we may use the central pin of the
            city/district. Since pincode is editable/updateable node, therefore
            this can be updated whenever we are able to get it or compute it.
          </p>
          <p>
            Few important queries [ detail queries are at the end of the
            document]
          ...
          <ul>
            ...
            <li>
              p. Find similar people (based on any criteria) for a neighborhood
              of a given pincode
            </li>
          </ul>
          <br></br>
          ...
          <ul>
            ...
            <li>
              s. Find all similar profile people (based on any criteria) who are
              in a given state
            </li>
          </ul>
          <p>6. Profile</p>
          ...
          <p>
            ...
            know that not every customer takes surveys so it’s better to have a
            node that represents a customer profile.
          </p>
          <ul>
          ...
          <ul>
            ...
            <li>
              u. Find all people who has their profile similar to a given person
              (same as above except it takes PersonID)
            </li>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    ECregistrationMonth, ECregistrationYear, Status, CreatedDate
                  </td>
                </tr>
                <tr>
                  <td>Node Modifiability</td>
          ...
          <ul>
            ...
            <li>
              y. Find all persons who have booked the consultations but not yet
              consulted
            </li>
            <li>
            ...
            <table border="1">
              <tbody>
                ...
                <tr>
                  <td>Properties</td>
                  <td>
                    AgeAtInsurance, Policy Type, Policy Status, Policy Creation
                    Month, Policy Creation Year, Policy Maturity Month, Policy
                    Maturity Year
                  </td>
                </tr>
                <tr>
            ...
            <table border="1">
              <tbody>
                ...
                <tr>
                  <td>Properties</td>
                  <td>
                    AgeAtLoanRegistration, DateOfBirth, Gender, Marital Status,
                    Education Qualification, Purpose of Loan, Related Loan
                    Details, Employment Details, Loan Registration Day, Month,
                    and Year
                  </td>
                </tr>
                <tr>
          ...
          <p>
            ...
            different therefore, we have Gender, Marital Status, and DOB as node
            properties.
          </p>
          <ul>
            <li>
            ...
            <table border="1">
              <tbody>
                ...
                <tr>
                  <td>Properties</td>
                  <td>
                    Amount, Payment Type, Transaction Type, PaymentTypeCategory,
                    PayeePaymentAddress, MerchantCatCode, TransactionHr,
