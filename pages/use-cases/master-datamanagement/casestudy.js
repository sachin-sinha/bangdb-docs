  ...
  return (
    <React.Fragment>
      ...
      <DocArticle>
        ...
        <h1 className="article-title"> BangDB Benchmark for Streamoid</h1>
        <div className="article-body">
          <h2>Introduction</h2>
          <p>
            The benchmark is specific to the use case of the Streamoid’s product
            Catalogix on MongoDB. The Catalogix is a platform for managing
            ecommerce product catalog for several stores, marketplaces etc. for
            world’s best retailers providing them with AI automations built for
            retail.
          </p>
          <p>
            As part of POC, BangDB has been deployed to bring in the convergence
            of various elements for more efficient storage of data and
            processing. The major goals for the POC are to assess the
            ...
            achieve this BangDB has implemented a Schema which defines the logic
            for ingestion of events/data, processing of various elements, some
            running stats, ETL etc. as part of the stream processing. Further it
            also defines the logic for auto-updating the underlying graph to
            maintain the sub-pred-obj triple to allow query to leverage the
            natural relationships for query and avoid the run time joins etc.
            There are many other aspects which we have not yet implemented and
            integrated namely ML of stream, pattern/anomaly detection, actions,
            etc. which could be later augmented as required.
          </p>
          <p>
          ...
          <ul>
            <p>
              Streamoid: Around 25GB database on Prod on MongoDB, so we tried to
              use 3X overall of this size on BangDB
            </p>
            <p>
          ...
          <h2>Machine</h2>
          <ul>
            Cloud: GCP <br></br>VM: c2-standard-16 ,<br></br>RAM: 64GB <br></br>
          ...
          <ul>
            <p>
              All tests are done using REST APIs. The C++, Java clients could be
              used for far better performance, but the Catalogix works using
              REST API hence we used the same.
            </p>
            <p>
            ...
            <ul>
              <li>Content-Type: application/json, Content-Type: text/plain</li>
          ...
          <p>
            The queries used are the ones that are run on Catalogix all the time
            for various interactions. To compare the performance numbers for
            these queries with Catalogix and BangDB, following dataset was used.
          </p>
          <ul>
          ...
          <p>
            ...
            more queries on BangDB and below are their performance numbers (time
            in milli sec)
          </p>
          <div className="table-container">
            <table>
              ...
              <tbody>
                ...
                <tr>
                  <td>query21</td>
                  <td>Fetch selected data for all images related to a store</td>
                  <td>329</td>
                  <td>659</td>
                </tr>
                <tr>
          ...
          />
          <p>
            The above were numbers for read operations, now in next section, we
            will go into write performances.
          </p>
          ...
          <p>
            The benchmark test for write was done for Product data, Marketplace
            data and Status data. The test was run with following details.
          </p>
          <ul>
          ...
          <p>
            ...
            insert just one record. Whereas Marketplace data is moderate, and it
            requires just 13 write operations and no read at all. Finally,
            status data is light weight since it involves only 2 write
            operations and no read for inserting one status record.
          </p>
          <p>
            The data was split into multiple parts and the summary of each part
...
8. status_details_1_8.json - 4 MB`}
          ...
          <p>
            Below are the charts depicting the behaviour of the operations from
            beginning to end.
          </p>
          <h2>Product Data</h2>
          <img
          ...
          <ul>
            <li>
              ...
              bottleneck of low performance as it’s ~10-15X faster on an average
              for slower queries over there.
            </li>
            <li>
            ...
            <li>
              ...
              efficiently. This may allow user to maintain and scale gracefully.
            </li>
            <li>
              The write operations with mixed reads as well, scales well. It
              provides high IOPS for concurrent write of different kind of data
              in continuous manner. Therefore, it will allow users to perform
              read and write in random and mixed manner with high performance.
            </li>
            <li>
              Catalogix integration should be simple as there are only 5 queries
              for which it needs to make changes at the FE level.
            </li>
            <li>
            ...
            <li>
              There are quite a few scope of improvements in the implementation
              too, but we can optimize later.
            </li>
          </ul>
        </div>
      </DocArticle>
