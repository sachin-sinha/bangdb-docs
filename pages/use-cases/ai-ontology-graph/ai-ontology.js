        ...
        <div className="article-body">
          ...
          <div>
            <p>
              ...
              customers as soon as they start typing the issue-related details.
            </p>
            <h2>Stream Layer</h2>
            <img
          ...
          <div>
            ...
            <p>
              ...
              ontology creation app which provided a readable interpretation for
              router-based issues using ontology graphs based on domain
          ...
          <ul>
            ...
            <li>
              Presence of ML/IE layer to perform sentiment analysis which helps
              in suggesting a relevant solution to a user who is facing
          ...
          <ul>
            ...
            <li>
              We have kept the machines learning at work and train the knowledge
              base for product and support.
            </li>
            ...
            <li>
              Produce a structured representation in semantically precise format
              - which is easily understandable and accessible.
            </li>
          ...
          <p>
            ...
            LaunchPad event where we collaborated on an additional use-case. We
            have been associated with them since early 2017.We realized their
            potential fairly early after which we on-boarded them under formal
            contract as vendor somewhere around Q2-2017.
          </p>
          <p>
            IQLECT has worked on initial ontology project for Cisco product and
            support pages to help automate processes in the CRM team. Together
            we deployed the platform along with solution within Cisco in Q3 2017
            and we are exploring deeper integration with the platform for more
            use cases. This has also been presented to Cisco leadership who are
            very impressed with their overall work.Our experience working with
            IQLECT has been very good, we value their product and offerings and
            based on our experience we’ve also offered their services to other
            service entities within Cisco who are looking towards solving
          ...
          <p>
            ...
            users to enable complex use cases effectively and in short period of
            time. An integrated ML/IE layer gives our solution a much-needed
            edge.
          </p>
          <p>
            ...
            potential going forward and look forward to a much deeper engagement
            with them.
          </p>
          <div>
            <p>
