...
export default function RecommendationSystemOverview() {
  const handleDownload = () => {
    ...
    link.href = "/assets/case-study/Recommendation-System.pdf";
    link.download = "Recommendation-System.pdf";
    ...
    <React.Fragment>
      ...
      <DocArticle>
        ...
        <div id="article-content">
          <h1 className="article-title-new">Recommendation System</h1>
          <div className="article-body">
            <h2>Introduction</h2>
            <p>
              Recommendation System is a platform which offers various
              financial, insurance and healthcare/wellness products and
              solutions to the customers/users. The discussion in the document
              is limited to the recommendation system which will help the
              Recommendation System in serving customers and users in much
              better/personalized ways. It will also aid the platform in
              achieving continuously improving and lasting relationships with
              the customers
            </p>
            ...
            <ul>
              <li>
                ...
                customers, largely based on customers’ profile, behavior,
                trends, tendencies, desires, and discovery. At the same time, it
                should also leverage entities, their relationships, similarities
                within the context.
              </li>
              <li>
                It should use Graph, ML, CEP, and continuous stream data
                analysis techniques for the recommendation purposes.
              </li>
              <li>
                Should be the unified data source for customer profile,
                behavior, and other details and allow queries on the same in
                different ways.
              </li>
              <li>
              ...
              <li>
                ...
                the Recommendation System platform and other
                applications/services as required.
              </li>
              <li>
              ...
              <li>
                It should be configurable as much as possible; such that
                different processing logic could be added/edited as and when
                necessary.
              </li>
              <li>
              ...
              <li>
                The entire project is quite large in scope and hence we should
                be able to add and release in a staggered manner over a period.
              </li>
            </ul>
            <p>
              The backbone of the recommendation system is in the understanding
              of the customers. And based on this we must construct a set of
            ...
            <p>
              There are many other entities here, but the majority of
              computations happen on these two items.
            </p>
            ...
            <p>
              ...
              maintain an entity table for the same as well for ready usage of
              the continuous pre-aggregated data. Most of these data will be
              part of the Graph itself with different set of relationships
              between the nodes
            </p>
            <ul>
            ...
            <p>
              <strong>
                Patterns for customer behaviors for various computations
              </strong>
            </p>
            ...
            <p>
              We are basically dealing with several entities and some
              interactions between those entities with different properties.
              While recommending the products or solutions, we must ensure that
              we improve the customer’s/user’s experience. Therefore, it’s
              imperative that we have a solid understanding of not just the
              entities but also the context in which they exist. Hence when it
              comes to storing the data, we need to ensure that
            </p>
            <ul>
              <li>
                We have the context also stored in an efficient manner along
                with entities [ isolated non-related structure is not
                sufficient, need relations]
              </li>
              <li>
                We need relationships or linking of entities but at the same
                time we need to have scalable and flexible model [ Can’t use
                RDMBS, need to break the cold coupling]
              </li>
              <li>
              ...
              <li>
                We should be able to query the database using these
                relationships along with various other constraints related to
                entities and relations properties
              </li>
              <li>
              ...
              <li>
                We should be able to find related entities given a set of
                entities and set of relationships
              </li>
              <li>
              ...
              <li>
                We should be able to do time series data ingestion and
                processing for continuously update and evolve the structure and
                keep continuous statistics / aggregation happening for run time
                efficiency
              </li>
              <li>
                We should be able to maintain and continuously update the
                long-term data for entities such that these could be leveraged
                at run time
              </li>
              <li>
                We should be able to train models on the data existing within
                the structure such that the models keep updating itself in
                continual manner and update the existing structure
                automatically.
              </li>
            </ul>
            <ul>
            ...
            <p>
              Therefore, we will have to use a combination of the following.
            </p>
            <ul>
              <li>
                Graph store for entities and relationships along with various
                other defined or computed properties along with ML integration
                for prediction (batch or runtime)
              </li>
              <li>
            ...
            <p>
              While (a) & (b) are mostly driven by the input data (the raw
              data). Whereas (c), (d), (e) etc. are data enriched by several
              mechanisms, like “catr”, “join” etc. by event processing,
              clustering, similarity, common groupings, community detection
              through label propagation, path finding, centrality etc. in graph
              processing along with bringing the whole set of ML algos to the
              Graph and Event processing as required.
            </p>
            <p>
              Let’s look at the graph structure (subject to change (most likely
              it will by 20-30%)) which depicts largely (a) & (b) as defined
              above
            </p>
            <img
            ...
            <p>
              One of the most difficult and heavy tasks for such processing is
              ETL and it’s widely recognized that sometimes we spend the
              majority of our time in ETL to try to get it right, otherwise a
              heavy penalty awaits if even a minor thing goes wrong at the
              beginning. BangDB avoids this process to great extent by
              implementing continuous data ingestion mechanism along with
              processing that could be done to extract and transform what we
              need at any given time. Here are some of the benefits of using
              this for the project
            </p>
            <h2>Data Processing and Analysis</h2>
            <p>
              The system integrates Graph Store and Stream Processing for
              efficient data handling. Graph structures are enriched with
              computed relationships and analyzed using ML techniques like
              clustering, association rule mining, and collaborative filtering.
            </p>
            <ul>
              <li>
              ...
              <li>
                ...
                UDFs for custom transformations as required. Going beyond, we
                can simply attach an ML model to add predicted value as part of
                the event
              </li>
              <li>
                We can run CEP to find interesting patterns (in absolute manner)
                and send the data to another stream, graph as needed. This
                hugely enriches the data structure.
              </li>
              <li>
              ...
              <li>
                ...
                enriched data along with raw events which makes the structure
                way more valuable.
              </li>
              <li>
                ...
                but it’s extremely fast and efficient due to continuous
                processing vs batch processing (SQL or MapR) .
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                transactions T = &#123;t1, t2, &#8230;&#125; (Set of items)
                would be stored in the graph as entities and relations such that
                the value Conf is computed and stored in the graph for the
                purpose of finding if X is purchased, then Y can also be
                purchased with the confidence Conf. The confidence is a measure
                of the number of evidence of the events when X is bought then Y
                is also bought.
              </li>
              <li>
                The scores/Conf will be stored in the graph itself such that
                these can be used at run time for decision making. Again, this
                will also be self-maintaining as we will schedule the
                computations for re-eval and update
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                cleaning, correlation, etc. will be avoided. Further models
                could be trained automatically with defined frequencies and
                linked within the graph for run time predictions as well
              </li>
              <li>
                Graph inbuilt clustering mechanisms, groups identifications
                should be leveraged for this as these are evolving continuously
                and very fast in nature. We can also train ML models explicitly
                using the set of the features already pre-baked in the graph .
              </li>
              <li>
                For recommendation engine_1 we are planning to cluster users
                based on their Language, Gender, Age, City, State, dependency,
                Marriage status, and education. The result of clustering will be
                given to the collaborative filtering recommendation system.
              </li>
              <li>
            ...
            <h2>
              ...
              limited set of values to identify similar users – coupled with
              graph it makes it very effective
            </h2>
            <ul>
              <li>
              ...
              <li>
                The Collaborative filter technique works by building a matrix
                for attributes of the user. The matrix is then used to match
                users with relevant interests and preferences by calculating
            ...
            <ul>
              <li>
                For Loan recommendation we will be using a Classification model
                to predict the probability of a customer to apply for a loan.
                They will recommend a loan based on the probability value from
                the model.
              </li>
              <li>
                For the dataset we know that approx. 1.5 % of the customers
                apply for a loan. The dataset is small and highly imbalanced.
                Therefore, for the classification model will use
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                principle of popularity and or anything which is in trend. These
                systems check about the products which are in trend or are most
                popular among the users and directly recommend them.
              </li>
              <li>
