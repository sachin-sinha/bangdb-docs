...
export default function ResultSetEmbedded() {
  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta
          name="description"
          content="Learn more about BangDB Result Set (Embedded). Read the documentation to learn to make embedded applications using BangDB."
        ></meta>
        <meta property="og:site_name" content="BangDB Docs" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Result Set (Embedded) - BangDB" />
        <meta
        ...
        <meta name="twitter:title" content="Result Set (Embedded) - BangDB" />
        <meta
        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Result Set (Embedded)</h1>
              <div className="article-body">
                ...
                >
                  <p>To create ResultSet (Embedded) object</p>
