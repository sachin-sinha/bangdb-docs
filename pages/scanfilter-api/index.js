...
export default function ScanFilterAPI() {
  const [tab, setTab] = useState(1);

  return (
    <React.Fragment>
      <Head>
        <title>Scan Filter - BangDB</title>
        <meta
          name="description"
          content="Learn about BangDB Scan Filter & server APIs. Read the documentation to know more about BangDB Server APIs."
        ></meta>
        <meta property="og:site_name" content="BangDB Docs" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Scan Filter - BangDB" />
        <meta
        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Scan Filter</h1>
