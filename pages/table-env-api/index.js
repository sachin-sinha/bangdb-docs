...
export default function TableEnvApi() {
  const [tab, setTab] = useState(1);

  return (
    <React.Fragment>
      <Head>
        <title>Table Env - BangDB</title>
        <meta
          name="description"
          content="Learn about BangDB Table Env & server APIs. Read the documentation to know more about BangDB Server APIs."
        ></meta>
        <meta property="og:site_name" content="BangDB Docs" />
        <meta property="og:type" content="article" />
        <meta property="og:title" content="Table Env - BangDB" />
        <meta
        ...
        <meta name="twitter:title" content="Table Env - BangDB" />
        <meta
        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Table Env</h1>
              <div className="article-body">
                ...
                >
                  <p>To create Table Env object</p>
                  ...
                  <aside className="doc-api-code">
                    <p>PersistType is an enum with following options:</p>
                    <p>
                      INMEM_ONLY
                      <br />
                      INMEM_PERSIST
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>IndexType is an enum with following options:</p>
                    <p>
                      HASH,
                      <br />
                      EXTHASH
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>LogType is an enum with following options:</p>
                    <p>
                      SHARED_LOG,
                      <br />
                      PRIVATE_LOG,
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>TableType is an enum with following options:</p>
                    <p>
                      NORMAL_TABLE
                      <br />
                      WIDE_TABLE
                  ...
                  <aside className="doc-api-code">
                    <p>KeyType is an enum with following options:</p>
                    <p>
                      NORMAL_KEY = 1
                      <br />
                      COMPOSITE_KEY = 3
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>SortMethod is an enum with following options:</p>
                    <p>
                      LEXICOGRAPH = 1,
                      <br />
                      QUASI_LEXICOGRAPH = 2,
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>SortDirection is an enum with following options:</p>
                    <p>
                      SORT_ASCENDING = 3,
                      <br />
                      SORT_DESCENDING = 4
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>TableSubType is an enum with following options:</p>
                    <p>
                      BANGDB_SW_TABLE
                      <br />
                      BANGDB_TOPK_TABLE
                  ...
                  />
                  <p>To set value for PrimitiveDataType for a table</p>
                  <HighlightedCpp
                    code={`void setPrimDataType(PrimitiveDataType prim_data_type);`}
                  />
                  <aside className="doc-api-code">
                    <p>PrimitiveDataType is an enum with following options:</p>
                    <p>
                      PRIMITIVE_INT
                      <br />
                      PRIMITIVE_LONG
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>VersionType is an enum with following options:</p>
                    <p>
                  ...
                  />
                  <aside className="doc-api-code">
                    <p>TableSizeHint is an enum with following options:</p>
                    <p>
                      TINY_TABLE_SIZE
                      <br />
                      SMALL_TABLE_SIZE
                  ...
                  />
                  <p>To check if RevIdx is enabled</p>
                  <HighlightedCpp code={`bool getAllowRevIdx();`} />
                  <p>To set whether RevIdx is allowed or not</p>
                  <HighlightedCpp
                  ...
                  <p>To delete Table Env object</p>
                  <HighlightedCpp code={`virtual ~Table Env();`} />
                </div>
                <div
                  style={{
