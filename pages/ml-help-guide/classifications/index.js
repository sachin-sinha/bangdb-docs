  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <title>Classification - BangDB</title>
        <meta
          name="description"
        ...
        <meta property="og:title" content="Classification - BangDB" />
        <meta
        ...
        <meta name="twitter:title" content="Classification - BangDB" />
        <meta
      ...
      <DocArticle>
        ...
        <h1 className="article-title">Classification</h1>
