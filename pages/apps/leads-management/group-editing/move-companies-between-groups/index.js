        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Move companies between groups</h1>
              <div className="article-body">
                ...
                <img
                  ...
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/leads-management/click_on_move_company.jpg"
                />
                <p>As of now this company is in &quot;Group1&quot;.</p>
                <img
                  alt="Company editing - BangDB"
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/leads-management/pre_moved_pipe.jpg"
                />

                <p>
                  In order to move it to &quot;Group2&quot;, Select Group2 from
                  the dropdown and click on Save. The company will be moved to
                  &quot;Group2&quot;.
                </p>
                ...
                <img
                  ...
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/leads-management/move_to_new_group_form.jpg"
                />
                <p>
