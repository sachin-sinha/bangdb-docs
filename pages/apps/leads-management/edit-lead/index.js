        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Edit / work on lead</h1>
              <div className="article-body">
                <p>
                  In order to edit a lead, Go to the
                ...
                <p>
                  Now Click on lead row which you want to edit, in the leads
                  table. It will open the lead details page.
                </p>
