          ...
          <div className="article-content">
            <article className="article">
              ...
              <div className="article-body">
                ...
                <p>
                  Find the user for whom you want to update the details in
                  company, and expand it. It will list all the companies the
                  user is assigned to.
                </p>

                <p>Expand the company in which you want to edit the user.</p>

                <img
                  alt="Click on crm settings - BangDB"
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/leads-management/mcu_pipe_user_editing_in_company.jpg"
                />
