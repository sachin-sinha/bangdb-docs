        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Setup classifications</h1>
              ...
              <div className="article-body">
                ...
                <p>
                  Go to <strong>&quot;Classifications&quot;</strong>
                </p>
                ...
                <img
                  ...
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/leads-management/setup_classifications.jpg"
                />

                <p>
                  From here you can change the classifications list &amp;
                  Default selected classification.
                </p>

                <h2>Default selected classification</h2>

                <p>
                  When you manually create a lead, the classification you select
                  here will automatically be selected as default classification
                  for that lead.
                </p>
