  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta
          name="description"
          content="Step-by-step guide to send leads to users via WhatsApp."
        />
        ...
        <meta
          ...
          content="Learn how to send leads to users via WhatsApp using this guide."
        />
        <meta
          property="og:image"
          content="/assets/images/send-leads-whatsapp.jpg"
        />
        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              <Breadcrumb
                text="Send Leads via WhatsApp"
                url="/send-leads-whatsapp"
              />
              ...
              <div className="article-body">
                <ol>
                  ...
                  <li>
                    <p>
                      Click on the <strong>WhatsApp</strong> icon after
                      selecting the leads.
                    </p>
                    <img
                      alt="WhatsApp Icon"
                  ...
                  <li>
                    <p>
                      After clicking the WhatsApp icon, a sidebar will appear
                      where you can:
                    </p>
                    <ul>
                      <li>Manually enter a phone number.</li>
                      <li>
                        Select numbers from the dropdown (populated with numbers
                        from the selected leads).
                      </li>
                    </ul>
                    <p>
                      After selecting or entering the phone numbers, click{" "}
                      <strong>Send</strong>. The selected leads will be sent to
