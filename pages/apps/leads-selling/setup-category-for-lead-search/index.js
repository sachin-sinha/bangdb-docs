  ...
  return (
    <React.Fragment>
      <Head>
        ...
        <meta
          name="description"
          content="Set up a category for lead search in the application."
        />
        ...
        <meta
          ...
          content="Learn how to set up a category for lead search step by step."
        />
        <meta
          property="og:image"
        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              <Breadcrumb
                text="Set Up Lead Search"
                url="/setup-category-for-lead-search"
              />
              <h1 className="article-title">
                Set Up a Category for Lead Search
              </h1>
              <div className="article-body">
                <ol>
                  ...
                  <li>
                    <p>
                      After clicking on <strong>Manage Lead Category</strong>,
                      it redirects to the
                      <strong> Manage Lead Category</strong> page. If the
                      category is already present, it will be listed. If not,
                      you need to add it.
                      <a href="/add-category">
                        Click here to see how to add the category
                      </a>
                      .
                    </p>
                    <img
                  ...
                  <li>
                    <p>
                      If the category is already present and you want to set it
                      for lead search, click the <strong>Edit</strong> button
                  ...
                  <li>
                    <p>
                      After clicking <strong>Edit</strong>, fill in the
                      following details:
                    </p>
                    <ul>
                      <li>
                        <strong>Category Name:</strong> John
                      </li>
                      <li>
                        <strong>Category Description:</strong> Test select
                      </li>
                      <li>
                        <strong>CRM:</strong> Test CRM
                      </li>
                      <li>
                        <strong>Group:</strong> Test group
                      </li>
                      <li>
                        <strong>Pipe:</strong> Test pipe
                      </li>
                      <li>
                      ...
                      <li>
                        <strong>Unit Price for a Single Lead:</strong> Add the
                        price value.
                      </li>
                      <li>
                        <strong>Fields for the Search Page:</strong> Select the
                        fields to display.
                      </li>
                    </ul>
                    <img
                  ...
                  <li>
                    <p>
                      After completing the setup, click on{" "}
                      <strong>Save Draft</strong> from the
                  ...
                  <li>
                    <p>
                      Once saved as a draft, you also need to click{" "}
                      <strong>Save</strong> on the category page to finalize the
                      setup.
                    </p>
                    <img
                      alt="Save Category"
