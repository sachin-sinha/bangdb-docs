        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Delete host</h1>
              <div className="article-body">
                <p>
                  In order to delete a host, Navigate to the
                ...
                <p>
                  Click on <strong>&quot;Delete Host&quot;</strong> icon for the
                  host you want to delete.
                </p>
                ...
                <img
                  ...
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/click-on-delete-host.jpg"
                />
                ...
                <img
                  ...
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/delete-host-confirmation.jpg"
                />
