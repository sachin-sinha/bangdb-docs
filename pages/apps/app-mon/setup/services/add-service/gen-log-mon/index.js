          ...
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">
                Add generic log monitoring service
              </h1>
              <div className="article-body">
                ...
                <p>
                  In order to add a new generic log monitoring service, Navigate
                  to the
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <p>Path of the log file. (for ex: /home/ubuntu/mylog)</p>
                  </li>
                  <li>
                ...
                <img
                  ...
                  width={"100%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/add-gen-log-form.jpg"
                />
                ...
                <img
                  ...
                  width={"100%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/gen-log-mon-install-steps.jpg"
                />
              </div>
            </article>
            <NextPageButton />
