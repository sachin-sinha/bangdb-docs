        ...
        <main className="container">
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">Add linux monitoring service</h1>
              <div className="article-body">
                ...
                <p>
                  In order to add a new linux monitoring service, Navigate to
                  the
                ...
                <img
                  ...
                  width={"100%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/add-linux-mon-form.jpg"
                />
                ...
                <img
                  ...
                  width={"100%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/linux-mon-install-steps.jpg"
                />
              </div>
            </article>
            <NextPageButton />
