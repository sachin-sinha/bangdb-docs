          ...
          <div className="article-content">
            <article className="article">
              ...
              <h1 className="article-title">
                Add linux system log monitoring service
              </h1>
              <div className="article-body">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Select logs to monitor</strong>
                    <p>
                      Select the logs which you want to monitor. As of now
                      following logs can be monitored using this service:
                      <ol>
                        <li>Syslog</li>
                        <li>Authlog</li>
                        <li>Kernlog</li>
                        <li>Dmeglog</li>
                        <li>Ufwlog (Ubuntu / Debian)</li>
                        <li>Dpkglog (Ubuntu / Debian)</li>
                      </ol>
                    </p>
                  </li>
                  <li>
                ...
                <img
                  ...
                  width={"100%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/add-log-mon-form.jpg"
                />

                <p>
                  Click on <strong>&quot;Add service&quot;</strong>. The service
                  will get added. It will you some installation steps, by
                  following those steps you can start monitoring the logs.
                </p>
                ...
                <img
                  ...
                  width={"100%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/log-mon-install-steps.jpg"
                />
              </div>
            </article>
          </div>
