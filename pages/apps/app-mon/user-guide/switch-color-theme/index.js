            ...
            <article className="article">
              ...
              <div className="article-body">
                ...
                <img
                  ...
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/click-on-switch-theme.jpg"
                />

                <p>By default the light mode is selected.</p>

                <h2>Dark mode view</h2>

                <img
                  alt="Click on manage company - BangDB"
                  width={"95%"}
                  height={"auto"}
                  src="/assets/apps/app-mon/dark-mode-view.jpg"
                />
              </div>
            </article>
            <NextPageButton />
